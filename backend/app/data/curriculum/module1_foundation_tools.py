...
""",
    ...
    \"\"\"
    # TODO: Очистите заголовок от краевых пробелов и приведите к нижнему регистру
    # TODO: Разбейте строку на слова и ограничьте список первыми max_words элементами
    # TODO: Объедините выбранные слова через дефис и верните slug
    pass
""",
            "hints": [
                {
...
""",
    ...
    \"\"\"
    # TODO: Рассчитайте subtotal с учетом переданных дополнительных сборов *fees
    # TODO: Вычислите величину налога и итоговую сумму с округлением round(..., 2)
    # TODO: Верните словарь с финансовыми полями и метаданными из **metadata
    pass
""",
            "hints": [
                {
...
""",
    ...
    \"\"\"
    # TODO: С помощью Dict Comprehension сформируйте словарь {id: 'Имя (Город)'}
    # TODO: Включите только совершеннолетних пользователей (age >= min_age)
    pass
""",
            "hints": [
                {
...
""",
    ...
    config = {}
    errors = []
    # TODO: Обойдите входные строки в цикле
    # TODO: В блоке try разделите строку по знаку '=' и преобразуйте значение в целое число
    # TODO: При ошибке ValueError сохраните проблемную строку в список errors
    # TODO: Верните словарь настроек и список ошибок
    pass
""",
            "hints": [
                {
